...
import { devide, fromSecondsToString, getComparingText, getDateRangeText, percentage } from "@/lib/utils";
...
export default function AvgSessionDuration({
  ...
  return (
    <div
      className="p-6 rounded-2xl flex flex-col gap-5 w-[322px] h-fit max-[1222px]:w-full"
